...
export const templateBuilder = (locationList: string[]): string => {
  ...
  const prompt = `${description}${formatInstructions}${humanRequestTitle}${inputTemplate}${humanRequestEnder}${assistantStart}`;
